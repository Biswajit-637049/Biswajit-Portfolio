...
const techStack = [
  { name: "HTML", icon: "🐳", color: "from-blue-400 to-blue-500", category: "Frontend" },
   { name: "CSS", icon: "TW", color: "from-teal-400 to-teal-500", category: "Styling" },
      { name: "Bootstrap", icon: "TW", color: "from-teal-400 to-teal-500", category: "Styling" },
  { name: "jQuery", icon: "AWS", color: "from-orange-400 to-orange-500", category: "Frontend" },
  ...
  { name: "Tailwind CSS", icon: "TW", color: "from-teal-400 to-teal-500", category: "Styling" },
  { name: "Node.js", icon: "N", color: "from-green-500 to-green-600", category: "Backend" },
  { name: "ExpressJs", icon: "E", color: "from-gray-600 to-gray-700", category: "Backend" },
  { name: "MongoDB", icon: "M", color: "from-green-600 to-green-700", category: "Database" },
  { name: "SQL", icon: "M", color: "from-green-600 to-green-700", category: "Database" },
...
const categories = ["All", "Language", "Frontend", "Backend", "Styling", "Database", "Deploy", "Tools"];
